						    ...
						    <table class="table table-bordered permission-table">
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("kitchen-index", $all_permission))
								                <input type="checkbox" value="1" id="kitchen-index" name="kitchen-index" checked />
								                @else
								                <input type="checkbox" value="1" id="kitchen-index" name="kitchen-index">
								                @endif
								                <label for="kitchen-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("kitchen-create", $all_permission))
								                <input type="checkbox" value="1" id="kitchen-create" name="kitchen-create" checked />
								                @else
								                <input type="checkbox" value="1" id="kitchen-create" name="kitchen-create">
								                @endif
								                <label for="kitchen-create"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("kitchen-edit", $all_permission))
								                <input type="checkbox" value="1" id="kitchen-edit" name="kitchen-edit" checked>
								                @else
								                <input type="checkbox" value="1" id="kitchen-edit" name="kitchen-edit">
								                @endif
								                <label for="kitchen-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("kitchen-delete", $all_permission))
								                <input type="checkbox" value="1" id="kitchen-delete" name="kitchen-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="kitchen-delete" name="kitchen-delete">
								                @endif
								                <label for="kitchen-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("bar-index", $all_permission))
								                <input type="checkbox" value="1" id="bar-index" name="bar-index" checked />
								                @else
								                <input type="checkbox" value="1" id="bar-index" name="bar-index">
								                @endif
								                <label for="bar-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("bar-create", $all_permission))
								                <input type="checkbox" value="1" id="bar-create" name="bar-create" checked />
								                @else
								                <input type="checkbox" value="1" id="bar-create" name="bar-create">
								                @endif
								                <label for="bar-create"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("bar-edit", $all_permission))
								                <input type="checkbox" value="1" id="bar-edit" name="bar-edit" checked>
								                @else
								                <input type="checkbox" value="1" id="bar-edit" name="bar-edit">
								                @endif
								                <label for="bar-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("bar-delete", $all_permission))
								                <input type="checkbox" value="1" id="bar-delete" name="bar-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="bar-delete" name="bar-delete">
								                @endif
								                <label for="bar-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("table-index", $all_permission))
								                <input type="checkbox" value="1" id="table-index" name="table-index" checked />
								                @else
								                <input type="checkbox" value="1" id="table-index" name="table-index">
								                @endif
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("table-add", $all_permission))
								                <input type="checkbox" value="1" id="table-add" name="table-add" checked />
								                @else
								                <input type="checkbox" value="1" id="table-add" name="table-add">
								                @endif
								                <label for="table-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("table-edit", $all_permission))
								                <input type="checkbox" value="1" id="table-edit" name="table-edit" checked>
								                @else
								                <input type="checkbox" value="1" id="table-edit" name="table-edit">
								                @endif
								                <label for="table-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("table-delete", $all_permission))
								                <input type="checkbox" value="1" id="table-delete" name="table-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="table-delete" name="table-delete">
								                @endif
								                <label for="table-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
