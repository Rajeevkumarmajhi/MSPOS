        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              @can('kitchen-index')
                <li>
                  <a class="nav-item" href="{{ route('kitchen.index') }}"><i class="dripicons-cart"></i>Kitchen Panel</a>
                </li>
              @endcan

              @can('bar-index')
                <li>
                  <a class="nav-item" href="{{ route('bar.index') }}"><i class="dripicons-cart"></i>Bar Panel</a>
                </li>
              @endcan

              @can('table-index')
                <li>
                  <a class="nav-item" href="{{ route('table.index') }}"><i class="dripicons-view-apps"></i>Table</a>
                </li>
              @endcan
