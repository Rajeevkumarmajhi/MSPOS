...
Route::get('reset-permission','RoleController@resetPermission');
...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	// Kitchen Routes
	Route::get('kitchen/sales','SaleController@kitchenSale')->name('kitchen.index');
	Route::post('kitchen/sales/update','SaleController@updateCookingStatus')->name('cooking.status.update');

	// Bar Routes
	Route::get('bar/sales','SaleController@barSale')->name('bar.index');
