...
@if(session()->has('custom_error'))
    <div class="alert alert-danger alert-dismissible text-center"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{!! session()->get('custom_error') !!}</div> 
@endif
...
<section class="forms pos-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="display: none;">
                                        <div class="form-group">
                                            <input style="display:none;" type="hidden" name="warehouse_id_hidden" value="1">
                                            <select style="display:none;" id="warehouse_id" name="warehouse_id" data-live-search="true" data-live-search-style="begins" title="Select warehouse...">
                                                @foreach($lims_warehouse_list as $warehouse)
                                                @if($loop->first)
                                                    <?php $warehouse_id = $warehouse->id; ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select id="table_id" name="table_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select table...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select id="waiter_id" name="waiter_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Waiter..." required>
                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2" style="display:none;">{{trans('file.Batch No')}}</th>
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #e28d02" type="button" class="btn btn-custom" id="draft-btn"><i class="dripicons-flag"></i> Start Order</button>
                        </div>
                        <div class="column-5" style="display:none;">
                        ...
                        <div class="column-5">
                            <button style="background-color: #acc10e;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#kitchenStatus"><i class="dripicons-clock"></i> Running Orders</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label>To be Received Amount *</label>
            ...
            <!-- recent transaction modal -->
            <div id="kitchenStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Recent Transaction')}} <div class="badge badge-primary">{{trans('file.latest')}} 10</div></h5>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                          @if($draft->cooking_status==1)
                                              <span class="badge badge-warning">Not Started</span>
                                          @elseif($draft->cooking_status==2)
                                              <span class="badge badge-primary">Cooking</span>
                                          @else
                                              <span class="badge badge-success">Ready to serve</span>
                                          @endif
                                      </td>
                                      <td>
                                        <div class="btn-group">
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-4 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button><br>' + data[1] + '<p>In Stock: <span class="in-stock"></span></p></td>';
    if(data[12]) {
        cols += '<td class="col-sm-2" style="display:none;"><input type="text" class="form-control batch-no" value="'+batch_no[pos]+'" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="'+product_batch_id[pos]+'"/> </td>';
    }
    else {
        cols += '<td class="col-sm-2" style="display:none;"><input type="text" class="form-control batch-no" disabled/> <input type="hidden" class="product-batch-id" name="product_batch_id[]"/> </td>';
    }
